...
class PointGroup(nn.Module):
    def __init__(self, cfg):
        ...
        ### same network architecture as PointGroup
            ...
            module_map = {
                'module.stuff_input_conv': self.stuff_conv, 'module.stuff_unet': self.stuff_unet,
                'module.stuff_output_layer': self.stuff_output_layer, 'module.stuff_linear': self.stuff_linear,
                'module.input_conv': self.input_conv, 'module.unet': self.unet,
                'module.output_layer': self.output_layer,
            }
